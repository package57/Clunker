...
I wrote this program, long ago, as a console application. I've modified it over time.
...
class CLEditDB
{
    public:
        ...
        InputFile inputfile[25000];  /* 23,000 line is the biggest single 
        			Block of	 code I've ever seen aka "203" */
